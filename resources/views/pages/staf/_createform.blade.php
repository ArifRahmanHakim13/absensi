...
<!-- ✅ JABATAN SUDAH DISESUAIKAN DENGAN ENUM DATABASE -->
<div class="form-group row">
...
<div class="form-group row">
  ...
  <div class="col-sm-10">
    <textarea name="alamat"
      ...
      id="alamat" placeholder="Ketik Alamat">{{ old('alamat') }}</textarea>
...
<div class="form-group row">
  ...
  <div class="col-sm-10 input-group">
    <input type="password" name="password"
      ...
      id="password" placeholder="Ketik Password" required>
