...
{{-- Header --}}
<x-content-header :title="'Data Staf'" :btnBack="false"></x-content-header>
      ...
      <div class="col">
        <div class="card">
          <div class="card-header">
            <a href="{{ route('staf.create') }}" class="btn btn-sm float-left btn-primary btn-icon-split">
                      ...
                      @foreach ($staf as $item)
                        <tr>
                          ...
                          <td class="project-actions">
                            <div class="btn-group">
                              <a class="btn btn-success btn-sm mx-1" href="{{ route('staf.show', $item) }}" data-toggle="tooltip" data-placement="top" title="Show">
                                  <i class="fas fa-eye"> </i>
                                  {{-- Show --}}
                              </a>
                              <a class="btn btn-warning btn-sm mx-1" href="{{ route('staf.edit', $item) }}" data-toggle="tooltip" data-placement="top" title="Edit">
...
<script>
  $('.btn-delete').on('click', function(){
    ...
    $('#form-delete').attr('action', '/staf/' + $(this).data('id'));
