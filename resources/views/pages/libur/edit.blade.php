...
{{-- Header --}}
<x-content-header :title="'Data Hari Libur'" :btnBack="true" :redirect="'/libur'"></x-content-header>
      ...
      <div class="col-lg-6">
        <div class="card card-secondary">
          <div class="card-header align-items-center">
            <h3 class="card-title pt-1">Edit Data Hari Libur</h3>
          ...
          <form class="form-horizontal" action="{{ route('libur.update', $libur) }}" method="POST">
          @csrf
          @method('PUT')

            <div class="card-body">

              @include('pages.libur._editform')
