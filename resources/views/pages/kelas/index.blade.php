...
{{-- Header --}}
<x-content-header :title="'Data Kelas'" :btnBack="false"></x-content-header>
      ...
      <div class="col">
        <div class="card">
          <div class="card-header">
            <a href="{{ route('kelas.create') }}" class="btn btn-sm float-left btn-primary btn-icon-split">
                    ...
                    @foreach ($kelas as $item)
                      <tr>
                        ...
                        <td class="project-actions">
                          <div class="btn-group">
                            <a class="btn btn-warning btn-sm mx-1" href="{{ route('kelas.edit', $item) }}" data-toggle="tooltip" data-placement="top" title="Edit">
                                <i class="fas fa-pencil-alt"> </i>
                                {{-- Edit --}}
                            </a>
                            <button type="button" class="btn btn-danger btn-delete btn-sm mx-1" data-toggle="tooltip" data-placement="top" title="Delete" data-id="{{ $item->id }}" data-name="{{ $item->name }}">
