...
{{-- Header --}}
<x-content-header :title="'Data Pertahun'" :btnBack="true" :redirect="'/tapel'"></x-content-header>
      ...
      <div class="col-lg-6">
        <div class="card card-secondary">
          <div class="card-header align-items-center">
            <h3 class="card-title pt-1">Tambah Data Pertahun</h3>
          ...
          <form class="form-horizontal" action="{{ route('tapel.store') }}" method="POST">
          @csrf
