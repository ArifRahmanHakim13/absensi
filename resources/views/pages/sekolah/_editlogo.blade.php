...
<small class="fs-12"> <i>Ganti logo puskesmas</i></small>
<form action="{{ url('/sekolah/updatelogo') }}" method="POST" enctype="multipart/form-data" id="form-update-logo">
    ...
    <div class="">
      <div class="input-group mb-3">
        <input type="file" accept="image/*" class="form-control logo-field" name="logo" id="gambar" onchange="previewImage()" required>
