<div class="form-group row">
  ...
  <div class="col-sm-10">
    <input type="text" name="name" value="{{ old('name', $kapus->user->name) }}" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="Ketik Nama Kepala Puskesmas" required>
...
<div class="form-group row">
  ...
  <div class="col-sm-10">
    <input type="number" name="nip" value="{{ old('nip', $kapus->nip) }}" class="form-control @error('nip') is-invalid @enderror" id="nip" placeholder="Ketik ID">
...
<!-- <div class="form-group row">
  ...
  <div class="col-sm-10">
    <input type="number" name="nuptk" value="{{ old('nuptk', $kapus->nuptk) }}" class="form-control @error('nuptk') is-invalid @enderror" id="nuptk" placeholder="Ketik NUPTK">
  ...
  <div class="col-sm-10">
    <select name="jk" id="jk" class="form-control selectTwo @error('jk') is-invalid @enderror" data-width="100%" required>
      ...
      @foreach (['laki-laki','perempuan'] as $item)
        <option value="{{ $item }}" {{ old('jk', $kapus->user->jk) == $item ? 'selected' : '' }}>{{ $item }}</option>
      @endforeach
    </select>
...
<div class="form-group row">
  ...
  <div class="col-sm-10">
    <input type="number" name="telepon" value="{{ old('telepon', $kapus->user->telepon) }}" class="form-control @error('telepon') is-invalid @enderror" id="telepon" placeholder="Ketik Telepon/WA">
...
<div class="form-group row">
  ...
  <div class="col-sm-10">
    <textarea type="text" name="alamat" class="form-control @error('alamat') is-invalid @enderror" id="alamat" placeholder="Ketik Alamat" >{{ old('alamat', $kapus->user->alamat) }}</textarea>
...
<div class="form-group row">
  ...
  <div class="col-sm-10">
    <input type="text" name="username" value="{{ old('username', $kapus->user->username) }}" class="form-control @error('username') is-invalid @enderror" id="username" placeholder="Ketik Username" required>
